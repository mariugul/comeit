...
class Header():
    ...
    def has_type(self) -> tuple[bool, str]:
        ...
        success = True
        error_msg = f"No colon found. Cannot identify a type."
    ...
    def has_scope(self) -> bool:
        ...
        :(word) is a valid scope and :(word and much more) is not. However it is recognized as scope
        either way.
    ...
    def scope_chars(self):
        ...
        A scope MUST be one word with no newlines, spaces, tabs, underscores, hyphens etc. Strictly
        [a-z].
    ...
    def has_summary(self):
        ...
        The summary can in principle be any character. A colon will be confusing. Should colon be
        allowed?
